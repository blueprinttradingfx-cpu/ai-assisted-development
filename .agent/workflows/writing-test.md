...
Review `project-management/tickets/T-{name}/testing/testing.md` and ensure it mirrors the base template before writing tests.
...
- Identify required sections from `project-management/tickets/T-{name}/testing/testing.md` (unit, integration, manual verification, coverage targets)
...
- Update `project-management/tickets/T-{name}/testing/testing.md` sections with links to test files and results
