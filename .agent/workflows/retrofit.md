---
description: Adopt the Three-Layer Framework around a legacy or existing project.
---

Retrofit the requested existing project into the AI Assisted Development Framework.
