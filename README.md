...
> [!TIP]
> **Domain-Specific Workflows**: After placing your project in the `web-applications/` directory, provide your tech stack details to the AI coding agent. Ask it to "Create a domain-level agent workflow following best practices for [`your tech stack`] and save it to the **[.agent/workflows/](./.agent/workflows/)** directory of your project `web-applications/<your-project-name>` folder".
